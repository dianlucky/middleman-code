                    ...
                    <div class="page-title-box">
                        <div class="btn-group float-right">
                            <ol class="breadcrumb hide-phone p-0 m-0">
                                <li class="breadcrumb-item"><a href="#">Middleman</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 stock-detail">
                                    <p>
                                        <i class="mdi mdi-cellphone text-primary mr-2 mt-3 font-24"></i>20%
                                        Mobiles
                                    </p>
                                    <p>
                                        <i class="mdi mdi-tablet-android text-success mr-2 mt-3 font-24"></i>20%
                                        Tablets
                                    </p>
                                    <p>
                                        <i class="mdi mdi-laptop text-danger mr-2 mt-3 font-24"></i>20%
                                        Laptops
                                    </p>
                                    <p>
                                        <i class="mdi mdi-television text-info mr-2 mt-3 font-24"></i>40%
                                        Televisions
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="card m-b-30 border-0">
                        <div class="card-body text-center">
                            ...
                            <div class="text-center">
                                ...
                                <button class="btn btn-block btn-raised btn-info mb-3">
                                    Follow
                                </button>
                            </div>
                                ...
                                <div class="owl-inner row">
                                    ...
                                    <div class="col-10">
                                        <p>
                                            ...
                                            typesetting industry. A list is perfect for
                                            defining terms."
                                        </p>
                                        <h6 class="text-right mr-1 mb-0">
                                            - Robert Kennedy
                                        </h6>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-6 col-sm-3 border-right usa">
                                    <p class="data-attributes text-center">
                                        <span
                                            data-peity='{ "fill": ["#6954cd", "#eeeeee"],   "innerRadius": 20, "radius": 24 }'>7/10</span>
                                    </p>
                                    <h6 class="text-muted">
                                        USA
                                        <span class="float-right">70%</span>
                                ...
                                <div class="col-6 col-sm-3 border-right afri">
                                    <p class="data-attributes text-center">
                                        <span
                                            data-peity='{ "fill": ["#0fb795", "#eeeeee"],   "innerRadius": 20, "radius": 24 }'>6/10</span>
                                    </p>
                                    <h6 class="text-muted">
                                        Africa
                                ...
                                <div class="col-6 col-sm-3 border-right">
                                    <p class="data-attributes text-center ind">
                                        <span
                                            data-peity='{ "fill": ["#eb6296", "#eeeeee"],   "innerRadius": 20, "radius": 24 }'>5/10</span>
                                    </p>
                                    <h6 class="text-muted">
                                        India
                                ...
                                <div class="col-6 col-sm-3">
                                    <p class="data-attributes text-center can">
                                        <span
                                            data-peity='{ "fill": ["#f5b741", "#eeeeee"],   "innerRadius": 20, "radius": 24 }'>4/10</span>
                                    </p>
                                    <h6 class="text-muted">
                                        Canada
